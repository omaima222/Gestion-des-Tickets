...
<div id="">
        ...
        <div class="matchTicketDetails d-flex">
            ...
            <div class="details1 mx-5">
                ...
                <h4 ><img style="width: 1.1rem;  margin-right: 0.5rem;" src="Location-Icon-by-arus-2.jpg" alt=""> {{stadium}}</h4>
                <h4 ><img style="width: 1.2rem;  margin-right: 0.5rem;" src="calendar-icon-vector-flat-symbol-illustration-164304880.jpg" alt=""> {{date}}</h4>
            </div>
        </div>
