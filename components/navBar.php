            ...
            <form class="d-flex">
                ...
                if (isset($_SESSION['userId'])) {
                    ...
                    <div class="mx-3 dropdown">
                        <img style="width:3rem; height:3rem;" class="dropdown-toggle rounded-circle" role="button"
                             data-bs-toggle="dropdown" aria-expanded="false"
                             src="../assets/images/users pfp/<?php echo $users['image']; ?>" alt="user pfp">
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="../pages/profile.php?updateId=<?= $users['id']; ?>">Edit
                                    profile</a></li>
                            <li>
                                <button class="dropdown-item" name="logout" type="submit">Log out</button>
                            </li>
                            <li>
                                <button class="dropdown-item" name="deleteAcc" type="submit"
                ...
                <?php } else { ?>
                    <button class="btn btn-login px-3" type="submit"><a class="login" href="../pages/logIn.php">Log
                            In</a></button>
                    <button class="btn btn-signup ms-3 px-3" type="submit"><a class="signup" href="../pages/signUp.php">Sign
                            Up</a></button>
                <?php } ?>
