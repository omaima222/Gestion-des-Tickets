...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <a href="#stadium_modal" onclick="clearModal()" data-bs-toggle="modal"
       class="d-none d-sm-inline-block btn btn-sm shadow-sm text-white" style="background-color: #8A1538;"><i
                ...
                foreach (get_stadiums() as $stadium) {
                    echo "
                            <tr>
                                ...
                                <td><img class='rounded' src='../assets/images/stadium/$stadium[image]' style='height: 30px' alt='stadium image'></td>
                                <td>
        ...
        <div class="modal-content">
            <form action="dashboard.php" method="POST" id="form" enctype="multipart/form-data" data-parsley-validate>
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <input type="file" class="form-control" name="stadium-image" id="stadium-image"
                               accept="image/png, image/jpeg" required>
                    </div>

                    <div class="mb-3">
                        <label class="form-label" for="stadium-name">Name</label>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" name="save_stadium" class="btn btn-primary" id="stadium-save-btn">Save
                    </button>
                </div>
            </form>
        </div>
