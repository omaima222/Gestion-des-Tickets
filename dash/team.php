...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <a href="#team_modal" onclick="clearModal()" data-bs-toggle="modal"
        ...
        <div class="table-responsive">
            <table class="table table-bordered" id="dataTable">
                ...
                foreach (get_teams() as $team) {
                    echo "
                            <tr>
                                <td><img class='rounded' src='../assets/images/team/$team[logo]' style='height: 30px' alt=''></td>
                                <td>$team[name]</td>
                                <td>$team[groupe]</td>
                                <td><img class='rounded' src='../assets/images/team/$team[image]' style='height: 30px' alt=''></td>
                                <td>
        ...
        <div class="modal-content">
            <form action="dashboard.php" method="POST" id="form" enctype="multipart/form-data" data-parsley-validate>
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label class="form-label" for="team-group">Group</label>
