                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            ?>
                                    <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        ...
                                        <img class="img-profile rounded-circle" src="../assets/images/users pfp/<?php echo $users['image']; ?>">
                                    </a>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            foreach ($stadiums as $stadium) {
                                                ...
                                                $DisTicketscount2 = $DisTicketscount2 + $DisTicketscount;
                                            }
                                            ?>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $DisTicketscount2 ?></div>
                                        </div>
                                        <div class="col-auto">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            $reservationscount = 0;
                                            $reservationscount2 = 0;
                                            foreach ($reservations as $reservation) {
                                                $reservationscount = $reservation['quantity'];
                                                $reservationscount2 = $reservationscount2 + $reservationscount;
                                            }
                                            ?>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $reservationscount2 ?></div>
                                        </div>
                                        <div class="col-auto">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <?php
                                            $RestTicketscount = $DisTicketscount2 - $reservationscount2;
                                            ?>
